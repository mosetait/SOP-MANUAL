...
// fetch stockists for ledger creation
const fetchStockists = asyncHandler(async (req, res, next) => {

  const stockists = await User.find({ type: "stockist" });
